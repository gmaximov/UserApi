        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChiefFIO = table.Column<string>(maxLength: 200, nullable: true),
                    Member = table.Column<string>(maxLength: 4000, nullable: true),
                    MemberPhoneNumber = table.Column<string>(maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Persons_ShortName_Inn_FullName",
                table: "Persons",
                columns: new[] { "ShortName", "Inn", "FullName" },
                unique: true);
